...
["- Excusez-moi mais vous êtes en train d’uriner sur ma voiture.  -Hein ? Ho, Ha oui ! … Mais c’est parce que j’ai la même là bas, j’ai confondu ! … Je peux finir ? - Oui.", "Les bronzés font du ski. "]]
     ...
     console.log('hello' + arrayOfQuotes.length)
     function btn(){
    ...
    button.addEventListener('click', function(){
        console.log(arrayOfQuotes[btn()][0])
        document.getElementById("cite").textContent = arrayOfQuotes[btn()][0] 
        document.getElementById("cite").textContent = arrayOfQuotes[btn()][1] 
    }) 

    

    console.log(btn)
    // function changecite(arrayOfQuotes)
